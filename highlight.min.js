...
this.buffer+=a(e)}openNode(e){if(!r(e))return;const n=((e,{prefix:n})=>{
...
;t+=A.substring(e),S.addText(t)}function g(){null!=x.subLanguage?(()=>{
...
const a=N.classNameAliases[e[t]]||e[t],i=n[t];a?u(i,a):(A=i,c(),A=""),t++}}
function m(e,n){
return e.scope&&"string"==typeof e.scope&&S.openNode(N.classNameAliases[e.scope]||e.scope),
e.beginScope&&(e.beginScope._wrap?(u(A,N.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
A=""):e.beginScope._multi&&(b(e.beginScope,n),A="")),x=Object.create(e,{parent:{
value:x}}),x}function p(e,n,a){let i=((e,n)=>{const t=e&&e.exec(n)
;return t&&0===t.index})(e.endRe,a);if(i){if(e["on:end"]){const a=new t(e)
;e["on:end"](n,a),a.isMatchIgnored&&(i=!1)}if(i){
for(;e.endsParent&&e.parent;)e=e.parent;return e}}
if(e.endsWithParent)return p(e.parent,n,a)}function _(e){
return 0===x.matcher.regexIndex?(A+=e[0],1):(D=!0,0)}function h(e){
const t=e[0],a=n.substring(e.index),i=p(x,e,a);if(!i)return ee;const r=x
;x.endScope&&x.endScope._wrap?(g(),
u(t,x.endScope._wrap)):x.endScope&&x.endScope._multi?(g(),
b(x.endScope,e)):r.skip?A+=t:(r.returnEnd||r.excludeEnd||(A+=t),
g(),r.excludeEnd&&(A=t));do{
x.scope&&S.closeNode(),x.skip||x.subLanguage||(C+=x.relevance),x=x.parent
}while(x!==i.parent);return i.starts&&m(i.starts,e),r.returnEnd?0:t.length}
let y={};function w(a,r){const o=r&&r[0];if(A+=a,null==o)return g(),0
;if("begin"===y.type&&"end"===r.type&&y.index===r.index&&""===o){
if(A+=n.slice(r.index,r.index+1),!s){const n=Error(`0 width match regex (${e})`)
;throw n.languageName=e,n.badRule=y.rule,n}return 1}
if(y=r,"begin"===r.type)return(e=>{
const n=e[0],a=e.rule,i=new t(a),r=[a.__beforeBegin,a["on:begin"]]
;for(const t of r)if(t&&(t(e,i),i.isMatchIgnored))return _(n)
;return a.skip?A+=n:(a.excludeBegin&&(A+=n),
g(),a.returnBegin||a.excludeBegin||(A=n)),m(a,e),a.returnBegin?0:n.length})(r)
;if("illegal"===r.type&&!i){
const e=Error('Illegal lexeme "'+o+'" for mode "'+(x.scope||"<unnamed>")+'"')
;throw e.mode=x,e}if("end"===r.type){const e=h(r);if(e!==ee)return e}
if("illegal"===r.type&&""===o)return 1
;if(R>1e5&&R>3*r.index)throw Error("potential infinite loop, way more iterations than matches")
;return A+=o,o.length}const N=v(e)
;if(!N)throw K(o.replace("{}",e)),Error('Unknown language: "'+e+'"')
;const O=Q(N);let k="",x=r||O;const M={},S=new d.__emitter(d);(()=>{const e=[]
;for(let n=x;n!==N;n=n.parent)n.scope&&e.unshift(n.scope)
;e.forEach((e=>S.openNode(e)))})();let A="",C=0,T=0,R=0,D=!1;try{
if(N.__emitTokens)N.__emitTokens(n,S);else{for(x.matcher.considerAll();;){
R++,D?D=!1:x.matcher.considerAll(),x.matcher.lastIndex=T
;const e=x.matcher.exec(n);if(!e)break;const t=w(n.substring(T,e.index),e)
;T=e.index+t}w(n.substring(T))}return S.finalize(),k=S.toHTML(),{language:e,
value:k,relevance:C,illegal:!1,_emitter:S,_top:x}}catch(t){
if(t.message&&t.message.includes("Illegal"))return{language:e,value:J(n),
illegal:!0,relevance:0,_illegalBy:{message:t.message,index:T,
context:n.slice(T-100,T+100),mode:t.mode,resultSoFar:k},_emitter:S};if(s)return{
language:e,value:J(n),illegal:!1,relevance:0,errorRaised:t,_emitter:S,_top:x}
...
s=!1},n.safeMode=()=>{s=!0},n.versionString="11.8.0",n.regex={concat:m,
...
className:"attr",begin:t+n.lookahead(":"),relevance:0},x,{
...
contains:["self"]}),a=[e.C_LINE_COMMENT_MODE,t],i={match:[/\./,p(...Oe,...ke)],
className:{2:"keyword"}},r={match:m(/\./,p(...Me)),relevance:0
},s=Me.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:p(...Me.filter((e=>"string"!=typeof e)).concat(xe).map(ve),...ke)}]},l={
...
match:m(/`/,$e,/`/)},k=[O,{className:"variable",match:/\$\d+/},{
className:"variable",match:`\\$${Be}+`}],x=[{match:/(@|#(un)?)available/,
